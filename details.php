...
<body>
   ...
   <div id="content"><!-- #content Begin -->
       <div class="container"><!-- container Begin -->
               ...
               <div id="productMain" class="row"><!-- row Begin -->
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           <h1 class="text-center"><?php add_cart(); ?>
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">Shipping County</label>
                                   
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       
                                       <select name="shipping_county" class="btn btn-primary form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick shipping county for the product')"><!-- form-control Begin -->
        ...
        PRICE: <del>Ksh $pro_price</del></br>
