...
<head>
    ...
    <title>Manis cosmetics - Admin</title>
       ...
       <?php include("includes/sidebar.php"); ?>
        ...
        <div id="page-wrapper"><!-- #page-wrapper begin -->
            <div class="container-fluid"><!-- container-fluid begin -->
               ...
               }   if(isset($_GET['view_confirmedPayments'])){
                        
                        include("view_confirmedPayments.php");
                ...
                }   if(isset($_GET['shipped_orders'])){
                        
                        include("shipped_orders.php");

                }   if(isset($_GET['unshipped_orders'])){
                        
                        include("unshipped_orders.php");
